...
#This script sets a Tello EDU drone to Access Point mode.
#Code adapted from: https://tello.oneoffcoder.com/swarm.html
#Run code with the following command: python setAPMode.py -s [SSID] -p [PASSWORD]
